...
select * from subject_nomal where credit between 3 and 5;
update student set class_id = 2 where student_id = 1;
select student.student_name, subject_nomal.sub_name, mark.mark
from student inner join mark on student.student_id = mark.student_id
inner join subject_nomal on mark.sub_id = subject_nomal.sub_id
